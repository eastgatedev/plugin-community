...
### 跨 8 个提供商的 146+ LLM 模型
通过我们扩展的模型支持，包括 GPT-6 Astra、Claude Fable 5.1 等，**最高可节省 99.6% 的翻译成本**。

**最新模型（2026 年 9 月）：**
- **OpenAI：** GPT-6 Astra（最高质量）、GPT-5.6 Sol/Terra/Luna、GPT-5 Nano（最具成本效益）
- **Anthropic：** Claude Fable 5.1（最高质量）、Claude Opus 5、Claude Sonnet 5、Claude Haiku 4.5（最具成本效益）
- **Google Gemini：** Gemini 3.8 Flash（最新）、Gemini 3.1 Flash-Lite（免费层默认）、Gemini 2.5 Flash-Lite（最便宜）
...
|---------|--------------|-------------|
| **翻译语言** | 🔒 **最多 1 种目标语言** | ✅ **无限制** |
| **LLM 模型可用** | ✅ **146+ 模型**（8 个提供商） | ✅ **146+ 模型**（8 个提供商） |
| **旧模型检测** | ✅ **自动警报** | ✅ **自动警报** |
...
### 共享功能（免费版和专业版均可用）
- **146+ LLM 模型**跨 8 个提供商（Gemini、OpenAI、Anthropic、DeepSeek、Azure、OpenRouter、Ollama、自定义）
- **旧模型检测**，自动升级建议
