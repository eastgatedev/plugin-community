...
**此精简版插件已于 2025 年 11 月停止更新。**

### 🚀 切换到免费增值专业版

**i18n 翻译专业版：Web** 插件现在提供**免费增值模式**，免费包含所有精简版功能：

- **✨ 永久免费：** 一次翻译一种语言 + 完整的智能文本转 i18n 功能（Alt+Shift+]）
- **🌐 所有框架：** 免费版包含 React、Vue、Angular、Next.js 支持
- **🔄 与精简版相同的功能：** 您现在使用的所有功能，但具有升级路径
- **💎 无试用期：** 免费版永久有效，无时间限制
- **🚀 随时升级：** 随时激活专业版功能，获得无限语言和批量翻译

### 📥 迁移说明

1. **卸载** IDE 中的此精简版插件
2. **安装** [i18n 翻译专业版：Web](https://plugins.jetbrains.com/plugin/28020-i18n-translate-pro-web) 从 JetBrains 市场
3. **重新配置：** 您需要重新输入 API 密钥并重新配置设置
4. **使用免费版：** 继续使用相同功能（一次一种语言 + 智能文本转 i18n）
5. **随时升级：** 当您需要无限语言和批处理时购买许可证

**注意：** 迁移后需要重新配置设置和 API 密钥。

### 🔗 获取新插件

**[安装 i18n 翻译专业版：Web →](https://plugins.jetbrains.com/plugin/28020-i18n-translate-pro-web)**
