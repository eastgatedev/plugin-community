...
- 生产级语义高亮,130 个属性覆盖 Kotlin、Java 和基础语言
...
- **64 个 Kotlin 属性** – 函数、属性、类型参数、注解、伴生对象、扩展函数等均有独特且有意义的颜色
- **34 个 Java 属性** – 变量、字段、方法、构造函数、类型、注解和可见性修饰符,配有智能字体样式（粗体用于声明、斜体用于静态/抽象、下划线用于可重新赋值的变量）
- **32 个基础属性** 级联到所有语言 – 关键字、字符串、数字、注释在 Python、JavaScript 或 TypeScript 中保持一致
