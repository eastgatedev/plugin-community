...
- 生产级语义高亮,256 个属性覆盖 Kotlin、Java、Python、JavaScript、TypeScript、HTML、CSS、SASS、Angular 和基础语言
...
- **65 个 Kotlin 属性** – 函数、属性、类型参数、注解、伴生对象、扩展函数等均有独特且有意义的颜色
- **34 个 Java 属性** – 变量、字段、方法、构造函数、类型、注解和可见性修饰符,配有智能字体样式（粗体用于声明、斜体用于静态/抽象、下划线用于可重新赋值的变量）
- **50 个 JavaScript 和 TypeScript 属性** – 变量、函数、类、接口、导出符号（粗体）、装饰器、JSX/TSX 组件、枚举、类型别名和类型守卫
- **38 个 CSS 和 SASS/SCSS + 12 个 HTML/XML 属性** – 选择器、属性名、伪类、混入、@规则、插值、标签名、属性和命名空间前缀,覆盖整个 Web 技术栈
- **10 个 Angular 属性** – 信号、模板变量、双向/事件/属性绑定、结构性指令,以及 Angular 17+ 的 @if/@for/@switch 语法
- **15 个 Python 属性** – 函数、类、参数、独立的 `self` 参数、关键字参数、类型提示、类型参数、装饰器、内置函数和魔术方法;完整覆盖 Django/Flask/FastAPI
- **32 个基础属性** 级联到所有语言 – 关键字、字符串、数字、注释在所有打开的文件类型中保持一致
- **11 套独特配色方案** – 每款主题都有专业设计的语义配色方案,而非简单的色调偏移
- 所有 11 款主题 100% 通过 WCAG AA 验证
